...
public class SqlParser {
     ...
     */
    public static String addCondition(SQLSelectStatement statement, Map<String, Object> condition) {
        StringWriter out = new StringWriter();
     ...
     * @description: sql重组增加查询条件
     */
    public static String addConditionCanalColumn(SQLSelectStatement statement, Map<String, CanalEntry.Column> rowDataMap) throws IOException {
        ...
        for (String key : rowDataMap.keySet()) {
            ...
            condition.put(key, column.getValue());
        }
